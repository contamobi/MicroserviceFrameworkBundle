...
use Cmobi\MicroserviceFrameworkBundle\Routing\Matcher\MethodMatcherInterface;
...
class MethodRouter
{
    ...
    public function setOptions(array $options)
    {
        $this->options = [
            'cache_dir' => null,
            'debug' => false,
            'matcher_class' => 'Cmobi\\MicroserviceFrameworkBundle\\Routing\\Matcher\\MethodMatcher',
            'matcher_dumper_class' => 'Cmobi\\MicroserviceFrameworkBundle\\Routing\\Matcher\\Dumper\\PhpMatcherDumper',
    ...
    public function getMethodCollection()
    {
        if (null === $this->collection) {
            $this->collection = $this->loader->get('cmobi_msf.routing_loader'
