...
class ConfigCachePass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container)
    {
        ...
        foreach ($container->findTaggedServiceIds('cmobi_msf.config_cache.resource_checker') as $id => $tags) {
        ...
        $container->getDefinition('cmobi_msf.config_cache_factory')->replaceArgument(0, $resourceCheckers);
    }
}
